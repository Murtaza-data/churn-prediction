...
- **App (Streamlit):** _<add your Streamlit Cloud URL>_
...
A stacking ensemble was tested but did **not** beat XGBoost, confirming a real performance ceiling on this data. Chasing 85%+ accuracy on the Telco dataset requires either data leakage or overfitting — so tuning was stopped deliberately. **Recognizing that ceiling is itself an engineering decision.**
...
<!-- Add SHAP plots to screenshots/ and embed:
...
churn-prediction/
├── notebooks/
│   └── churn_training.ipynb   # EDA, feature engineering, model comparison, tuning, SHAP
├── data/
...
<!-- Add to screenshots/ and embed:
![App — churn prediction](screenshots/app.png)
![Model comparison](screenshots/model_comparison.png)
![SHAP summary](screenshots/shap_global.png)
-->
